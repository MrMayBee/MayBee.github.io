...
//  Taaza
//
//  Created by ZhangJC on 16/7/12.
//  Copyright © 2016年 MayBee Walson. All rights reserved.
//

#import "ZhaoTuiJian.h"
...
@interface ZhaoTuiJian ()<UIDynamicAnimatorDelegate>
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        //初始化图片
        _imageView = [[UIImageView alloc]initWithImage:[[UIImage imageNamed:@"2.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate]];
